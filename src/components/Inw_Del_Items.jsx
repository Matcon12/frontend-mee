...
function Inw_Del_Items() {
  ...
  useEffect(() => {
    if (submitted) {
      axios
        .post("http://18.209.166.105:8080/inward-dc-input/", values)
        .then((response) => {
      ...
      try {
        ...
        try {
          const response = await axios.get(
            `http://18.209.166.105:8080/getAdditionalInfo/${poNo}/${value}/`
          );
          ...
          const pn = await axios.get(
            `http://18.209.166.105:8080/get-part-name/${poDetails.part_id}/${cust_id}/`
          );
